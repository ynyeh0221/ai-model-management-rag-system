...
from src.core.colab_generator.colab_api_client import ColabAPIClient, AuthenticationError

FAKE_CREDS_JSON = '{"type": "service_account", "project_id": "demo"}'

class TestColabAPIClient(unittest.TestCase):

    @patch("src.core.colab_generator.colab_api_client.build")
    @patch("src.core.colab_generator.colab_api_client.Credentials")
    ...
    @patch("src.core.colab_generator.colab_api_client.nbformat.write")
    @patch("src.core.colab_generator.colab_api_client.nbformat.from_dict")
    @patch("src.core.colab_generator.colab_api_client.MediaFileUpload")
    @patch("src.core.colab_generator.colab_api_client.build")
    @patch("src.core.colab_generator.colab_api_client.Credentials")
    @patch("os.path.exists", return_value=True)
    @patch("builtins.open", new_callable=mock_open, read_data=FAKE_CREDS_JSON)
