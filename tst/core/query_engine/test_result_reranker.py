...
from src.core.query_engine.result_reranker import CrossEncoderReranker, DenseReranker, RerankerFactory
...
class TestCrossEncoderReranker(unittest.TestCase):
    ...
    def test_rerank_exception(self):
        ...
        with patch.dict('sys.modules', {'sentence_transformers': sentence_transformers_mock}):
            ...
            logger = logging.getLogger('src.core.query_engine.result_reranker')
...
class TestRerankerFactory(unittest.TestCase):
    ...
    @patch('src.core.query_engine.result_reranker.CrossEncoderReranker')
    ...
    @patch('src.core.query_engine.result_reranker.DenseReranker')
