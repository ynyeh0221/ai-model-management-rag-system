...
class LLMBasedCodeParser:
    ...
    def _extract_metadata_by_llm(self, code_str: str, file_path: str = "<unknown>", max_retries: int = 15) -> dict:
        ...
        final['framework'] = {'name': self.parse_framework(ast_digest), 'version': '2.7'}
    ...
    def extract_natural_language_summary(self, chunk_text: str, chunk_offset: int = 0, max_retries: int = 3) -> dict:
        ...
        system_prompt = (
            ...
            "The input you will receive is an Abstract Syntax Tree (AST) digest summary of a Python ML training script. This AST summary contains structured information about:\n"
            "- Imported libraries and modules\n"
            "- Class and function definitions\n"
            "- Model architecture components and parameters\n"
            ...
            "   - Provide a precise 1-2 sentence description of what the script accomplishes\n"
            "   - Mention all major features and functionalities present in the AST\n"
            "   - Frame the script's role within typical ML workflows\n\n"
    ...
    def generate_metadata_from_summary(self, summary: str, max_retries: int = 3, file_path: str = "<unknown>") -> dict:
        ...
        system_prompt = (
            ...
            "### INPUT FORMAT SPECIFICATION\n\n"
            "You will receive an AST digest summary of a Python ML training script. This structured representation contains "
            ...
            "- Trace data flow and parameter usage throughout the script\n"
