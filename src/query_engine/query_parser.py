    ...
    def __init__(self, nlp_model: str = "en_core_web_sm", use_langchain: bool = True, llm_model_name: str = "deepseek-llm:7b"):
        ...
        if use_langchain:
            try:
                ...
                - retrieval: Asking for general information about models (e.g., what they are, what they do)
                - comparison: Comparing multiple models
                - notebook: Generating code or analysis notebooks
                - image_search: Searching for images generated by models
                - metadata: Queries specifically about model metadata (such as creation date, last modified, file properties)
                ...
                Query: "Show me all models created after 2022"  
                →
                {
                  "filters": {
                    "created_year": "after 2022"
                  },
                  "limit": null,
                  "sort_by": null,
                  "timeframe": "created after 2022"
                }
