    ...
    def __init__(self, nlp_model: str = "en_core_web_sm", use_langchain: bool = True):
        ...
        if use_langchain:
            try:
                ...
                IMPORTANT INSTRUCTIONS FOR HANDLING FILTERS:
                1. Only include keys that are explicitly mentioned or strongly implied in the query.
                2. Do NOT include any keys with null/None values in the filters dictionary.
                3. Do NOT include 'model_id' in filters unless specific models are mentioned.
                4. If the query mentions 'all models', completely omit the model_id key rather than setting it to "all".
                5. For time-based queries (e.g., "models created in April"), include the time information (e.g., "created_month": "April") without any model_id entry.
