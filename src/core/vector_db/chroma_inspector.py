...
- `src.vector_db.chroma_manager`: Provides the ChromaManager class
- `src.vector_db.image_embedder`: Handles image embedding functionality
- `src.vector_db.text_embedder`: Handles text embedding functionality
