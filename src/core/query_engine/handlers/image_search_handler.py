...
class ImageSearchHandler:
    ...
    async def find_images_by_tag(self, tags: List[str], require_all: bool = False, user_id: Optional[str] = None):
        ...
        # Filter image_processing based on tags
        matching_images = []
        for image in all_images:
    ...
    async def _handle_image_search(self, query=None, parameters=None):
        ...
        try:
            if search_type == "model_id":
                # Search for image_processing by model ID
                ...
                # Search for image_processing by model ID and epoch
                model_id = parameters.get("filters").get("model_id")
                ...
                # Search for image_processing from the highest epoch
                model_id = parameters.get("filters").get("model_id")
                if not model_id:
                ...
                # Search for image_processing by content
                ...
                # Search for image_processing by tags
                ...
                # Search for image_processing by date
                ...
                # Search for image_processing by color
                ...
                # Search for image_processing by similarity
